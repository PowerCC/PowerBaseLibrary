...
public class QRCode: NSObject {
    ...
    public func syntheticImage(_ image: UIImage, iconImage: UIImage, width: CGFloat, height: CGFloat) -> UIImage {
        // 开启图片上下文
    ...
    public func setupHighDefinitionUIImage(_ image: CIImage, size: CGFloat) -> UIImage {
    ...
    // 生成边框
    public func circleImageWithImage(_ sourceImage: UIImage, borderWidth: CGFloat, borderColor: UIColor) -> UIImage {
